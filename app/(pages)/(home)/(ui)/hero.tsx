...
function Hero() {
  return (
    <div className="w-full h-screen px-11 pb-11 pt-40 md:pb-16 md:pt-28 flex flex-col justify-start md:justify-between items-center max-w-[1900px] max-h-[800px]">
      <Background />
      <Heading />
